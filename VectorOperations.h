...
void VectorMultiply(std::vector<double>& v1, const std::vector<double>& v2,double alpha,double beta);

// v1[i] + alpha * v2[i] * v3[i]
void VectorAddMult(std::vector<double>& v1,const std::vector<double>& v2,const std::vector<double>& v3,double alpha);
